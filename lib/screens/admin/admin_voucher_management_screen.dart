...
class AdminVoucherManagementScreen extends StatefulWidget {
  ...
  @override
  State<AdminVoucherManagementScreen> createState() => _AdminVoucherManagementScreenState();
}

class _AdminVoucherManagementScreenState extends State<AdminVoucherManagementScreen> with SingleTickerProviderStateMixin {
  static const int _vouchersPerPage = 20;
  final VoucherRepository _voucherRepo = VoucherRepository();
  List<VoucherModel> _vouchers = [];
  List<VoucherModel> _filteredVouchers = [];
  ...
  List<VoucherModel> get _paginatedVouchers {
    ...
    final startIndex = max(0, (_currentPage - 1) * _vouchersPerPage);
    final endIndex = min(startIndex + _vouchersPerPage, _filteredVouchers.length);
                              ...
                              child: ElevatedButton(
                                ...
                                child: Row(
                                  ...
                                  children: const [
                                    ...
                                    SizedBox(width: 8),
                                    Text('Thêm voucher mới', style: TextStyle(fontSize: 16)),
                                  ],
                                ),
                              ),
                            ),
                            ...
                            child: RefreshIndicator(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) => FadeTransition(
                                  ...
                                  child: ScaleTransition(
                                    scale: _scaleAnimation,
                                    child: _buildVoucherCard(_paginatedVouchers[index]),
                                  ),
                                ),
                              ),
                            ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (voucher.usedOrderIds.isEmpty)
                    const Text('Chưa có đơn hàng nào sử dụng', style: TextStyle(color: Colors.black54))
                  else
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: voucher.usedOrderIds
                          .map((orderId) => Text(
                                '- Đơn hàng: $orderId',
                                style: const TextStyle(color: Colors.black54),
                              ))
