...
class _VoucherWidgetState extends State<VoucherWidget> {
  ...
  Future<void> _loadVouchers() async {
    try {
      ...
      if (_vouchers.isEmpty) return;
      _voucherModel = _vouchers.where((voucher) => voucher.currentUsage < 5).first;
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        color: Colors.white, // Nền trắng thay cho màu cam
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 12,
                                color: Colors.blue.shade700, // Xanh đậm hơn cho phụ đề
                              ),
                            ),
                          ],
                        ),
            ...
            child: TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => VoucherListScreen(vouchers: _vouchers),
                  ),
                );
              },
              style: TextButton.styleFrom(
                foregroundColor: Colors.blue, // Văn bản và biểu tượng xanh dương
              ),
              child: Row(
                children: const [
                  Text("Xem tất cả", style: TextStyle(fontSize: 12)),
