...
//                     },
//                   ),
//                   // if (_userRepository.getCurrentUserId() != null)
//                   const SizedBox(height: 20),
//                   _buildTextFormField(
...
class _EditAddressScreenState extends State<EditAddressScreen> with SingleTickerProviderStateMixin {
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: const [
              Icon(Icons.check_circle, color: Colors.blue, size: 50), // Đổi màu xanh dương
              SizedBox(height: 16),
              Text(
                'Chỉnh sửa địa chỉ thành công!',
                style: TextStyle(fontSize: 16, color: Colors.blue), // Đổi màu xanh dương
              ),
            ],
          ),
        );
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          backgroundColor: Colors.white,
          title: const Text('Thông báo', style: TextStyle(color: Colors.blue)), // Đổi màu xanh dương
          content: Text(message, style: const TextStyle(color: Colors.black87)),
          actions: [
            TextButton(
              onPressed: () => Navigator.of(context).pop(),
              child: const Text('OK', style: TextStyle(color: Colors.blue)), // Đổi màu xanh dương
            ),
          ],
        );
      },
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          backgroundColor: Colors.white,
          title: const Text('Lỗi', style: TextStyle(color: Colors.blue)), // Đổi màu xanh dương
          content: Text(message, style: const TextStyle(color: Colors.black87)),
          actions: [
            TextButton(
              onPressed: () => Navigator.of(context).pop(),
            ...
            Container(
              ...
              child: const Center(
                child: CircularProgressIndicator(
                  valueColor: AlwaysStoppedAnimation<Color>(Colors.blue), // Màu xanh dương
                ),
              ),
            ),
        ],
  ...
  Widget _buildTextFormField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: labelText,
        labelStyle: TextStyle(color: Colors.blue.shade300), // Màu xanh nhạt cho nhãn
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: Colors.blue, width: 2), // Viền xanh đậm khi focus
        ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    title: Text(
                      ...
                      style: TextStyle(color: Colors.blue.shade700), // Màu xanh đậm
                    ),
                    onTap: () {
                      addressController.text = suggestion['description'];
                      fetchAddressDetails(suggestion['place_id']);
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          backgroundColor: Colors.white,
          title: const Text('Xác nhận xóa', style: TextStyle(color: Colors.blue)), // Màu xanh dương
          content: const Text('Bạn có chắc chắn muốn xóa địa chỉ này?', style: TextStyle(color: Colors.black87)),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              child: const Text('Hủy', style: TextStyle(fontSize: 16, color: Colors.blue)), // Màu xanh dương
            ),
            TextButton(
              onPressed: () async {
                Navigator.pop(context);
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Text(
                    'Không thể xóa địa chỉ mặc định!',
                    style: TextStyle(fontSize: 16, color: Colors.blue), // Màu xanh dương
                  ),
                ],
              ),
              actions: [
                TextButton(
                  onPressed: () => Navigator.of(context).pop(),
                  child: Text('OK', style: TextStyle(color: Colors.blue)), // Màu xanh dương
                ),
              ],
            );
          },
