            ...
            child: addressList.isEmpty
                ? Center(
                    child: FadeTransition(
                      ...
                      child: Text(
                        "Chưa có địa chỉ nào. Vui lòng thêm địa chỉ mới.",
                        style: TextStyle(color: Colors.blue.shade700, fontSize: 16), // Màu xanh đậm
                      ),
                    ),
                  )
                : ListView.builder(
                      ...
                      return FadeTransition(
                        ...
                        child: SlideTransition(
                          ...
                          child: Card(
                            ...
                            color: Colors.white,
                            child: InkWell(
                              onTap: _isUpdatingAddress ? null : () => _setDefaultAddress(index),
                              child: ListTile(
                                leading: Radio<int>(
                                  value: index,
                                  groupValue: selectedAddressIndex,
                                  onChanged: _isUpdatingAddress
                                      ? null
                                      : (int? value) {
                                          if (value != null) {
                                            _setDefaultAddress(value);
                                  ...
                                  activeColor: Colors.blue, // Màu xanh dương khi chọn
                                ),
                                title: Row(
                                  ...
                                  children: [
                                    ...
                                    TextButton(
                                      ...
                                      child: Text(
                                        "Sửa",
                                        style: TextStyle(color: Colors.blue), // Màu xanh dương
                                      ),
                                    ),
                                  ],
                                ),
