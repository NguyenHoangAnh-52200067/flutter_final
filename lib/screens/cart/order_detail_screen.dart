      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.local_shipping_outlined, color: Colors.blue), // Màu xanh dương
                const SizedBox(width: 8),
                Text(
                  'Thông tin giao hàng',
                  style: TextStyle(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.shopping_bag_outlined, color: Colors.blue), // Màu xanh dương
                const SizedBox(width: 8),
                Text(
                  'Sản phẩm (${order.orderDetails.length})',
                  style: TextStyle(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Divider(thickness: 1, color: Colors.blue.shade300), // Đường phân cách xanh nhạt
            ),
            _buildPriceRow('Tổng thanh toán', order.totalAmount, isTotal: true),
          ],
        ),
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            fontSize: isTotal ? 16 : 14,
            fontWeight: isTotal ? FontWeight.bold : FontWeight.normal,
            color: isTotal ? Colors.blue.shade700 : Colors.black54, // Màu xanh đậm cho tổng
          ),
        ),
        Text(
          isDiscount
          ...
          style: TextStyle(
            ...
            color: isDiscount
                ? Colors.green
                : (isTotal ? Colors.blue : Colors.blue.shade700), // Màu xanh dương
          ),
        ),
      ],
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDateRow(
              'Ngày đặt hàng',
              DateFormat('dd/MM/yyyy HH:mm a').format(order.orderDate).toString(),
            ),
            if (order.acceptDate != null) ...[
              const SizedBox(height: 14),
              _buildDateRow(
                'Ngày vận chuyển',
                DateFormat('dd/MM/yyyy HH:mm a').format(order.shippingDate!).toString(),
              ),
              const SizedBox(height: 14),
              _buildDateRow(
                'Ngày giao hàng',
                DateFormat('dd/MM/yyyy HH:mm a').format(order.deliveryDate!).toString(),
              ),
              const SizedBox(height: 14),
              _buildDateRow(
                'Ngày thanh toán',
                DateFormat('dd/MM/yyyy HH:mm a').format(order.paymentDate!).toString(),
              ),
            ],
          ],
        ),
