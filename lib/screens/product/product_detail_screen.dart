                          ...
                          children: [
                            Padding(
                              ...
                              child: ZoomIn(
                                ...
                                child: IconButton(
                                  icon: Icon(Icons.close, color: Color(0xFF2196F3)),
                                  onPressed: () {
                                    Navigator.pop(context);
                                  },
                                ),
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            ...variants.asMap().entries.map((entry) {
                              ...
                              bool isSelected = selectedOption == variant.productName;
                              return ZoomIn(
                      ...
                      Row(
                        children: [
                          ZoomIn(
                            duration: Duration(milliseconds: 500),
                            child: IconButton(
                              icon: Icon(Icons.remove, color: Color(0xFF2196F3)),
                              onPressed: () {
                                if (tmpQuantity > 1) {
                                  setModalState(() {
                                    tmpQuantity--;
                    ...
                    ZoomIn(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: stock == 0
                              ...
                              : () async {
                                  ...
                                  final cartItem = CartItem(
                                    ...
                                    quantity: quantity,
                                    discountRate: currentProduct.discount,
                                    priceAfterDiscount: currentProduct.price *
                                        (1 - currentProduct.discount / 100),
                                  );
                                  setState(() {
                                    stock -= quantity;
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: stock == 0 ? Colors.grey : Color(0xFF2196F3),
                            padding: EdgeInsets.symmetric(vertical: 14),
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10),
                            ),
              ...
              ElevatedButton(
                onPressed: () async {
                  final comment = CommentModel(
                    productId: widget.product.id!,
                    userId: userId,
                    userName: _userRepo.isUserId(userId)
                        ? (await _userRepo.getUserDetails(userId))!.fullName
                        : 'Khách',
                    content: commentController.text,
                    rating: _userRepo.isUserId(userId) ? rating : null,
                    createdAt: DateTime.now(),
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => AllCommentsScreen(product: widget.product),
                      ),
                    );
                  },
                  child: Text(
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 60), // Đệm để không bị che bởi bottomNavigationBar
                ],
              ),
            ),
          ],
  ...
  Widget _buildVariantOption(ProductModel variant, bool isSelected) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        color: isSelected ? Color(0xFFBBDEFB).withOpacity(0.3) : Colors.grey.shade100,
      ),
      child: Text(
        variant.productName,
        maxLines: 1,
